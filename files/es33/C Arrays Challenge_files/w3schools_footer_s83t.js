  ...
  if (m) {
    ...
    for (i = 0; i < x.length; i++) {
      ...
      if (d.indexOf(aa) >= 0 || bb) {
        ...
        } else if (x[i].parentElement.className.indexOf("step_bar") > -1 && x[i].parentElement.parentElement.className.indexOf("tut_overview") > -1) {
          x[i].parentElement.parentElement.style.display = "block";
          w3sElementAddClass(x[i].parentElement.parentElement.previousElementSibling, "active");
          w3sElementAddClass(x[i].parentElement.parentElement.previousElementSibling, "active_overview");
        }
        break;
