function displayInternalFeatures() {
  var internalFeatureRnd = Math.floor(Math.random() * (7 - 1)) + 1;
  ...
  var upclass1 = "ga-2026-summer-fullaccess";
  var upimgstart1 = "/images/img_2026_summer_fullaccess_";
  var upimgend1 = ".webp";
  var upimgsubject2 = "";
  var uplink2 = "https://campus.w3schools.com/collections/course-catalog";
  var upclass2 = "ga-2026-summer-cert-more";
  var upimgstart2 = "/images/img_2026_summer_cert_more_";
  var upimgend2 = ".webp";
  var upimgsubject3 = "";
  var uplink3 = "https://campus.w3schools.com/collections/course-catalog";
  var upclass3 = "ga-2026-summer-cert-start";
  var upimgstart3 = "/images/img_2026_summer_cert_start_";
  var upimgend3 = ".webp";
  var upimgsubject3 = "";
  var uplink4 = "https://campus.w3schools.com/collections/course-catalog";
  var upclass4 = "ga-2026-summer-cert-deal";
  var upimgstart4 = "/images/img_2026_summer_cert_deal_";
  var upimgend4 = ".webp";
  var upimgsubject4 = "";
  ...
  switch (subjectFolder) {
    case "accessibility":
      upimgstart4 = "/images/img_2026_cert_";
  ...
  upshowcaselink.classList.remove("ga-2026-summer-fullaccess");
  ...
  } else if (internalFeatureRnd == 6) {
    // Tools catalogue promo: swap the showcase image for a tools card in the same slot
    if (pictureEl) {
      pictureEl.style.display = 'none';
    }
    upshowcaselink.style.display = 'none';
    upshowcaselink.classList.add('ga-2026-tools');
    displayToolsAd();
  }
}

function displayToolsAd() {
  var showcaseLink = document.getElementById("upperfeatureshowcaselink");
  if (!showcaseLink || document.getElementById("tools-catalog-ad")) {
    return;
  }

  var featured = [
    { name: "Color Picker", file: "tool_color_picker.php", img: "img_picker" },
    { name: "Device Mockup", file: "tool_device_mockup.php", img: "img_mockup" },
    { name: "Gradient Generator", file: "tool_css_gradient.php", img: "img_gradient" },
    { name: "QR Code Generator", file: "tool_qrcode.php", img: "img_qr" }
  ];
  ...
  for (var i = 0; i < featured.length; i++) {
    var t = featured[i];
    thumbs +=
      '<a href="/tools/' + t.file + '" class="ga-right" title="' + t.name + '" ' +
      'style="display:block;height:100%;border:1px solid #eee;border-radius:6px;overflow:hidden;background:#f7f7f7;">' +
      '<picture style="display:block;height:100%;">' +
      '<source srcset="/images/' + t.img + '.webp" type="image/webp">' +
      '<img src="/images/' + t.img + '.png" alt="' + t.name + '" loading="lazy" ' +
      'style="width:100%;height:100%;object-fit:contain;display:block;">' +
      "</picture></a>";
  }

  // Fixed 300px-tall card whose width follows the slot (120 / 160 / 300), matching the
  // image-based carousel slides. The thumbnail grid flexes to fill the middle so the
  // card stays exactly 300px tall at every width. Sits beside the hidden showcase link.
  var ad = document.createElement("div");
  ad.id = "tools-catalog-ad";
  ad.style.cssText =
    "width:100%;max-width:300px;height:300px;border:1px solid #e8e8e8;border-radius:8px;" +
    "padding:14px 12px;background:#fff;box-sizing:border-box;display:flex;flex-direction:column;";
  ad.innerHTML =
    // Site-wide a:hover turns link text green; in this card just lighten instead (skip the CTA).
    "<style>#tools-catalog-ad a:not(.ws-btn):hover,#tools-catalog-ad a:not(.ws-btn):active{color:inherit;opacity:0.7;text-decoration:none;}</style>" +
    '<h4 style="margin:0 0 10px;display:flex;align-items:center;justify-content:center;gap:6px;">' +
    '<i class="fa fa-logo ws-text-green" aria-hidden="true" style="font-size:22px;"></i>' +
    '<a href="/tools/" id="tools-ad-title" class="ga-right">Free Developer Tools</a>' +
    "</h4>" +
    '<div style="flex:1;min-height:0;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:8px;">' +
    thumbs +
    "</div>" +
    '<a href="/tools/" class="ws-btn ga-right" ' +
    'style="display:block;width:100%;margin-top:12px;box-sizing:border-box;white-space:normal;">' +
    "Browse tools &raquo;</a>";

  showcaseLink.parentNode.insertBefore(ad, showcaseLink.nextSibling);

  // Add the "Free" prefix only when the card is wide enough (the 300px slot).
  var titleEl = document.getElementById("tools-ad-title");
  function _toolsAdRespond() {
    if (titleEl) {
      titleEl.textContent = (ad.offsetWidth >= 250) ? "Free Developer Tools" : "Developer Tools";
    }
  }
  if (window.ResizeObserver) {
    new ResizeObserver(_toolsAdRespond).observe(ad);
  }
  setTimeout(_toolsAdRespond, 0);
}